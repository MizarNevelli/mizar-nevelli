...
2. A set of interactive JavaScript explainers (event loop, event bubbling, closures, React) with step by step visualizers
...
4. Push to git; Vercel builds and deploys
